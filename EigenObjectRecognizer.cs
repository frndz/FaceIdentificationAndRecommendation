...
namespace Emgu.CV
{
    ...
    public class EigenObjectRecognizer
    {
        ...
        /// </summary>
        /// <remarks>The set method is primary used for deserialization, do not attempt to set it unless you know what you are doing</remarks>
        ...
        /// Set it to a huge number (e.g. 5000) and the recognizer will always treat the examined image as one of the known object. 
        /// </summary>
